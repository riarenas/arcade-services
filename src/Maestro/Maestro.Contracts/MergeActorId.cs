...
{
    /// <summary>
    ///     A factory that creates <see cref="ActorId" /> instances for MergeActors
    /// </summary>
    public static class MergeActorId
    {
        /// <summary>
        ///     Creates an <see cref="ActorId" /> identifying the MergeActor responsible for direct merges for the
